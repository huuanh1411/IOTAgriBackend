...
namespace IOTAgriBackend.Migrations
{
    ...
    [Migration("20260923150119_AddPumpScheduleOccurrences")]
    partial class AddPumpScheduleOccurrences
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("IOTAgriBackend.Models.AdminAuditLog", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("IOTAgriBackend.Models.Device", b =>
                {
                    ...
                    b.Property<string>("ProvisionedHardwareId")
                        .HasColumnType("text");

                    b.Property<DateTime?>("ProvisioningCodeExpiresAt")
                        .HasColumnType("timestamp with time zone");
                    ...
                    b.HasIndex("ProvisionedHardwareId")
                        .IsUnique();
            ...
            modelBuilder.Entity("IOTAgriBackend.Models.PumpSchedule", b =>
                {
                    ...
                    b.Property<DateTime?>("LastDispatchedOccurrenceUtc")
                        .HasColumnType("timestamp with time zone");
                    ...
                    b.ToTable("PumpSchedules", t =>
                        {
                            t.HasCheckConstraint("CK_PumpSchedules_DurationSeconds", "\"DurationSeconds\" > 0");

                            t.HasCheckConstraint("CK_PumpSchedules_WeekdayMask", "\"WeekdayMask\" > 0 AND \"WeekdayMask\" <= 127");
                        });
                });
            ...
            modelBuilder.Entity("IOTAgriBackend.Models.Device", b =>
                {
                    b.HasOne("IOTAgriBackend.Models.ApplicationUser", "Owner")
                        .WithMany("Devices")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("IOTAgriBackend.Models.ApplicationUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
